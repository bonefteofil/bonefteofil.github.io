...
Live: **[bonefteofil.ro](https://bonefteofil.ro)**

![Screenshot](Public/screenshot.jpg)

## Tech stack
I used modern web technologies to ensure good performance and future scalability.
- built with [React](https://react.dev) and [Vite](https://vite.dev) for a fast and optimized development experience.
- structured using [Tailwind](https://tailwindcss.com) CSS with well-thought components to ensure reusability and efficiency.
- [TypeScript](https://www.typescriptlang.org) is used for type checking, reducing errors and improves overall code quality.
...
- icons are downloaded from [SVG Repo](https://www.svgrepo.com/) and [Iconfinder](https://www.iconfinder.com/).
